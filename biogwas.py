...
if __name__ == '__main__':
    ...
    script_settings.add_argument('-d', 
                        '--dependencies', 
                        type=str, 
    ...
    input_settings.add_argument('-gf', 
                        '--gmt_file', 
                        required=False, 
                        type=str, 
    ...
    causal_settings.add_argument('-cs', 
                        '--causal_snps', 
                        required=False, 
                        type=str, 
    ...
    maf_settings.add_argument('-maf_min', 
                        '--causal_maf_min', 
                        default=0.05, 
                        required=False, 
                        type=float, 
    ...
    samples_settings.add_argument('-N', 
                        '--N', 
                        default=100, 
                        type=int, 
    ...
    sim_pheno_settings.add_argument('-gv', 
                        '--gen_var', 
                        required=False, 
                        default=0.5, 
                        type=float, 
    ...
    sim_pheno_settings.add_argument('-a', 
                        '--alpha', 
                        required=False,  
                        default=0.5,
                        type=float, 
